...
namespace Yazh {
	class YAPI Platform : public VirtualPlatform {
		static LRESULT CALLBACK win32ProcessMessage(HWND hwnd, u32 msg, WPARAM wParam, LPARAM lParam);
		...
		public:
			...
			bool startup(
				...
				wc.lpszClassName = "yazhWindowClass";
				...
				HWND handle = CreateWindowExA(
					windowExStyle, "yazhWindowClass", applicationName,
